  ...
  return (
    <div className="flex flex-col items-center">
                ...
                <div key={index} className="bg-white p-3 rounded-lg flex flex-col shadow-md border border-gray-200">
                  ...
                  <div className="mt-auto flex items-center space-x-3">
                    <a
                      ...
                      className={`flex-grow text-center bg-[#ff91af] hover:brightness-95 text-white font-bold py-2 px-3 rounded-md transition-all duration-300 text-xs flex items-center justify-center space-x-1.5 ${item.isLoading ? 'opacity-50 cursor-not-allowed' : ''}`}
                    >
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" /></svg>
                      <span>Download</span>
                    </a>
      ...
      <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-4">
        <button
          onClick={onReset}
          className="w-full sm:w-auto bg-gray-500 hover:bg-gray-600 text-white font-bold py-3 px-8 rounded-lg transition-all duration-300 text-lg flex items-center justify-center space-x-2"
        >
        ...
        <div className="relative" ref={batchMenuRef}>
            <button
                ...
                className="w-full sm:w-auto bg-gray-500 hover:bg-gray-600 text-white font-bold py-3 px-8 rounded-lg transition-all duration-300 text-lg flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            {isBatchMenuOpen && (
                <div className="absolute bottom-full mb-2 w-full sm:w-64 bg-white border border-gray-200 rounded-lg shadow-xl py-2 z-20">
                    ...
                    <ul className="text-gray-700">
                        ...
                        <li>
                            <button onClick={() => handleBatchBackgroundSelect('light gray')} className="w-full text-left px-4 py-2 text-sm hover:bg-[#ff91af] hover:text-white transition-colors duration-200">
                                Change background to Light Gray
                            </button>
                        </li>
                        <li>
                            <button onClick={() => handleBatchBackgroundSelect('transparent')} className="w-full text-left px-4 py-2 text-sm hover:bg-[#ff91af] hover:text-white transition-colors duration-200">
        ...
        <button
          ...
          className="w-full sm:w-auto bg-[#ff91af] hover:brightness-95 text-white font-bold py-3 px-8 rounded-lg transition-all duration-300 text-lg flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {isDownloadingAll ? (
            <>
